...
def convert_html_to_markdown(
    ...
    for tag in soup.find_all("a"):
        try:
            ...
            # Skip tags that cause errors during processing
            continue
    ...
    for tag, full_text, href in link_data:
        try:
            ...
            # Skip tags that can't be replaced properly
            continue
    ...
    for label in soup.find_all("label"):
        try:
            ...
            # Skip labels that cause errors during processing
            continue
    ...
    for tag in soup.find_all(["h1", "h2", "h3", "h4", "h5", "h6"]):
        try:
            ...
            # Skip headings that cause errors during processing
            continue
    ...
    for button in soup.find_all("button"):
        try:
            ...
            # Skip buttons that cause errors during processing
            continue
    ...
    for tag in soup.find_all(["ul", "ol"]):
        try:
            ...
            # Skip lists that cause errors during processing
            continue
    ...
    for tag in soup.find_all("strong"):
        try:
            ...
            # Skip strong elements that cause errors during processing
            continue
    ...
    for table in soup.find_all("table"):
        try:
            ...
            # Skip tables that cause errors during processing
            continue
    ...
    for span in soup.find_all("span"):
        try:
            ...
            # Skip spans that cause errors during processing
            continue
    ...
    for p in soup.find_all("p"):
        try:
            ...
            # Skip paragraphs that cause errors during processing
            continue
    ...
    for parent in soup.find_all():
        try:
            ...
            # Skip combinations that cause errors during processing
            continue
